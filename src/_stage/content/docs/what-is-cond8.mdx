...
## Want to see Cond8 in action?

Curious what Cond8 can actually do? 

<ResourceCard
  href="/docs/hello-director-example"
  title="See a Cond8 Example"
  description="Explore a real, working example of a Cond8 workflow and see how easy it is to build reliable, testable AI pipelines."
  icon="🚀"
/>

> **Fun fact:** This documentation site was built manually using Cond8 itself. That means Cond8 isn't just for AI-generated code—it's a robust, flexible framework for building real-world software by hand, too. If you're reading this, you're already seeing Cond8 in action!
